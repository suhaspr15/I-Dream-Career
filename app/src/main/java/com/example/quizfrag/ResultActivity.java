...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String personalityType=testMind(scoreM)+testEnergy(scoreE)+testNature(scoreN)+testTactics(scoreT);
            ...
            txtPersonality.setText( personalityName(personalityType));
        txtCareers.setText(personalityCareer(personalityType));
    ...
    {
        switch(ptype) {
            case "ISTJ": return "\n" +"\n"+ "\nWe believe,these are your suitable career recommendations \n \n" +"    Accountant\n" + "    Computer Programmer\n" + "    Dentist\n" +"    Doctor\n" +"    Librarian\n" +
            ...
            default:
                return "\n" + "\n" + "Please attend the questions in order to get our career recommendations";
